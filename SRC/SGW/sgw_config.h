...
#define SGW_CONFIG_STRING_SGW_IPV4_ADDRESS_FOR_S1U_S12_S4_UP_PUBLIC "SGW_IPV4_ADDRESS_FOR_S1U_S12_S4_UP_PUBLIC"
...
typedef struct sgw_config_s {
  ...
  struct {
    ...
    struct in_addr S1u_S12_S4_up_public;
    int            netmask_S1u_S12_S4_up;
    int            netmask_S1u_S12_S4_up_public;
